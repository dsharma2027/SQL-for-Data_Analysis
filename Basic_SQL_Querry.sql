/*
Basic SQL Quries for Data Analysis
...
/*LIMIT Clause
	...
	query that displays all the data in the occurred_at, account_id, and channel columns of the web_events table, 
...
/*
Filter the accounts table to include the 
...
SELECT id, account_id, (poster_amt_usd / (standard_amt_usd + gloss_amt_usd + poster_amt_usd))*100 AS POR_poster 
FROM orders
LIMIT 20
